        ...
        <tr>
          ...
          <td>{{ $record->governorate->name }}</td>
            <td  style="text-align: center;">
              <a href="{{ route('citie.edit',$record->id) }}" class="btn btn-primary"><i class="fa fa-edit fa-lg"></i></a>
              {!! CitieController::delete($record->id, $record->name) !!}
            </td>
        </td>
        </tr>
      @endforeach
      ...
      <div class="modal-body">
        {!! Form::open(['route'=>'citie.store', 'method'=>'POST']) !!}
          <div class="form-group">
                ...
                {!! Form::label('name', 'Citie') !!}
                {!! Form::text('name',old('name'),['class'=>'form-control','placeholder'=>'Citie Name', 'required'=>'required' ]) !!}   
          </div>
          <div class="form-group">
              <i class="fa fa-user"></i>
