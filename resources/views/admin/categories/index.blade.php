        ...
        <tr>
          ...
          <td>{{ $record->name }}</td>
            <td  style="text-align: center;">
              <a href="{{ route('category.edit',$record->id) }}" class="btn btn-primary"><i class="fa fa-edit fa-lg"></i></a>
              {!! CategoryController::delete($record->id, $record->name) !!}
            </td>
        </td>
        </tr>
      @endforeach
...
{{--  End Show category data  --}}

{{--  Strat Cteate category  --}}
